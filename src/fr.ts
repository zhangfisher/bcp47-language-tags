...
export const tags = {
  ...
  "zh-TW": {
    tag: "zh-TW",
    name: "Chinois (traditionnel - Taïwan)",
    nativeName: "繁體中文(中國臺灣)",
    primary: false,
  },
  "zh-HK": {
    tag: "zh-HK",
    name: "Chinois (traditionnel - Hong Kong)",
    nativeName: "繁體中文(中國香港)",
    primary: false,
  },
  "zh-MO": {
    tag: "zh-MO",
    name: "Chinois (traditionnel - Macao)",
    nativeName: "繁體中文(中國澳門)",
    primary: false,
  },
  "zh-SG": {
    tag: "zh-SG",
    name: "Chinois (simplifié - Singapour)",
    nativeName: "简体中文(新加坡)",
    primary: false,
  },
  "zh-CHS": {
  ...
  "en-NZ": {
    tag: "en-NZ",
    name: "Anglais (Nouvelle-Zélande)",
    nativeName: "English (New Zealand)",
    primary: false,
  },
  "en-IE": {
    tag: "en-IE",
    name: "Anglais (Irlande)",
    nativeName: "English (Ireland)",
    primary: false,
  },
  "en-PH": {
    tag: "en-PH",
    name: "Anglais (Philippines)",
    nativeName: "English (Philippines)",
    primary: false,
  },
  "en-ZW": {
    tag: "en-ZW",
    name: "Anglais (Zimbabwe)",
  ...
  "en-CB": {
    tag: "en-CB",
    name: "Anglais (Caraïbes)",
    nativeName: "English (Caribbean)",
    primary: false,
  },
  "en-JM": {
    tag: "en-JM",
    name: "Anglais (Jamaïque)",
    nativeName: "English (Jamaica)",
    primary: false,
  },
  "en-TT": {
    tag: "en-TT",
    name: "Anglais (Trinité-et-Tobago)",
  ...
  "es-DO": {
    tag: "es-DO",
    name: "Espagnol (République dominicaine)",
  ...
  "ar-AE": {
    tag: "ar-AE",
    name: "Arabe (Émirats arabes unis)",
  ...
  "nb-NO": {
    tag: "nb-NO",
    name: "Norvégien Bokmål (Norvège)",
    nativeName: "Norsk Bokmål (Norge)",
    primary: false,
  },
  "nn-NO": {
    tag: "nn-NO",
    name: "Norvégien Nynorsk (Norvège)",
  ...
  "id-ID": {
    tag: "id-ID",
    name: "Indonésien (Indonésie)",
    nativeName: "Bahasa Indonesia (Indonesia)",
    primary: false,
  },
  "ms-MY": {
    tag: "ms-MY",
    name: "Malais (Malaisie)",
  ...
  "ca-ES": {
    tag: "ca-ES",
    name: "Catalan (Catalogne)",
    nativeName: "Català (Catalunya)",
    primary: false,
  },
  "lt-LT": {
    tag: "lt-LT",
    name: "Lituanien (Lituanie)",
    nativeName: "Lietuvių (Lietuva)",
    primary: false,
  },
  "lv-LV": {
    tag: "lv-LV",
    name: "Letton (Lettonie)",
    nativeName: "Latviešu (Latvija)",
    primary: false,
  },
  "et-EE": {
    tag: "et-EE",
    name: "Estonien (Estonie)",
    nativeName: "Eesti (Eesti)",
    primary: false,
  },
  "sq-AL": {
    tag: "sq-AL",
    name: "Albanais (Albanie)",
    nativeName: "Shqip (Shqipëri)",
    primary: false,
  },
  "mk-MK": {
    tag: "mk-MK",
    name: "Macédonien (Macédoine du Nord)",
  ...
  "is-IS": {
    tag: "is-IS",
    name: "Islandais (Islande)",
    nativeName: "Íslenska (Ísland)",
    primary: false,
  },
  "gl-ES": {
    tag: "gl-ES",
    name: "Galicien (Galice)",
    nativeName: "Galego (Galicia)",
    primary: false,
  },
  "eu-ES": {
    tag: "eu-ES",
    name: "Basque (Pays basque)",
    nativeName: "Euskara (Euskal Herria)",
    primary: false,
  },
  "af-ZA": {
    tag: "af-ZA",
    name: "Afrikaans (Afrique du Sud)",
